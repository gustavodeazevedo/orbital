  ...
  (
    ...
    const splitIntoCharacters = (text: string): string[] => {
      if (typeof Intl !== "undefined" && (Intl as any).Segmenter) {
        const segmenter = new (Intl as any).Segmenter("pt", {
    ...
    // If boxed mode is enabled, animate whole words sliding inside a clipped box
    if ((rest as any).boxed) {
      return (
        <span
          className={cn(
            "inline-block align-middle",
            (rest as any).boxClassName,
          )}
